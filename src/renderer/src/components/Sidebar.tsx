        ...
        <div className="w-64 h-full bg-zinc-50 border-r border-zinc-200 flex flex-col p-4">
            ...
            <div className="space-y-1 flex-1">
                ...
                <SidebarItem
                    ...
                    onClick={onNavigate}
                    icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 7V4h16v3"></path><path d="M9 20h6"></path><path d="M12 4v16"></path></svg>}
                />
                <SidebarItem
                    id="notes"
                    label="Notes"
